	...
	<div id="main" class="scroll-container">
		<section class="section1">
			...
			<div>
				...
				<div class="main1-con">
					<button type="submit" class="btn-type1" onClick="location.href='/finally/vote/vote1.jsp'">
			...
			<div class="main2-con">
				<div class="main3-card">
					...
					<div class="card">
						...
						<button type="submit" class="btn-type1" onClick="location.href='/finally/mypage/myInfo.jsp'">
			...
			<div class="footerContainer">
				<div class="footer">
					<div class="txtArea">
						<div class="copyright">
							<div class="logoArea">
								<img src="../images/footerImg.png" alt="시흥시주민참여예산제">
							</div>

							<span>본 사이트는 시흥시 주민참여예산 접수를 목적으로 만들어진 사이트 입니다.</span> <span><br>Copyright©
								2021 한국산업기술대학교 IT경영학과. All Rights reserved.</span>
						</div>
					</div>
				</div>
			</div>
